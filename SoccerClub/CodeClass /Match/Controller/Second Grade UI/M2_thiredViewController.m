...
//    _scroll.backgroundColor = [UIColor greenColor];
    ...
    [_homeLoge sd_setImageWithURL:homeLogeUrl placeholderImage:[UIImage imageNamed:@"loadingimg.png"]];
    ...
    [_guestLoge sd_setImageWithURL:guestLogeUrl placeholderImage:[UIImage imageNamed:@"loadingimg.png"]];
